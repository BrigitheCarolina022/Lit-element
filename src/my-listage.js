...
export class mylistAge extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Lista Agenda</h3>
                <hr>
    
                <p>A continuación encontrara un listado que contiene la información de todas las agendas
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <button class="btn-new-acta">Buscar</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <form action="listAge.html" style="text-align: left;">
                ...
                <table class="table table-striped-columns">
                    <thead>
                        <tr>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Numero Agenda</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">titulo del evento</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Fecha</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Asistencia</th>
...
customElements.define('my-listage',mylistAge);