...
export class myLitpag extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Lista Pagos</h3>
                <hr>
    
                <p>A continuación encontrara un listado que contiene la información de todos los pagos que
                    se encuentran gestionadas en el sistema.</p>
                <br>
                <br>
                <div class="container-fluid">
                    <div class="row">
                ...
                <table class="table table-striped-columns">
                    <thead>
                        <tr>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Número Pago</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Concepto </th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Valor</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Fecha</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Banco</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Usuario Pago</th>
                        </tr>
                    </thead>
...
customElements.define('my-litpag',myLitpag);