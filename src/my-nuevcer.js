...
export class myNuevCer extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Nuevo Certificado</h3>
                <hr>
                <p>A continuación registre los datos basicos que identifican la certificacion a crear.</p>
                <br>
                <div class="container">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form >
                                        ...
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Cantidad" class="form-control input-text" name="cantidad">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-sm text-center">
                                            <input type="text" placeholder="Bodega" class="form-control input-text" name="bodega">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm">
                                            <input type="text" placeholder="responsable" class="form-control input-text" name="responsable">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-sm">
                                            <form action="ListaMater.html">
                                                <button tyoe="submit" class="btn-new-acta">Volver</button>
                                            </form>
                                        </div>
                                        <div class="col-sm">
                                            <form action="NuevCer.html">
...
customElements.define('my-nuevcer',myNuevCer);