...
export class myLisJuga extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <span class="text-list-font">Varios</span>
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3>Lista Jugadores</h3>
                <hr>
                <p>A continuación encontrara un listado de coachs del equipo PUMAS DC.</p>
                <br>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
...
customElements.define('my-listajuga',myLisJuga);