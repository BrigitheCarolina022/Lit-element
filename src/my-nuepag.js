...
export class myNuepag extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Nuevo Pago</h3>
                <hr>
                <p>A continuación registre los datos basicos que identifican el pago a crear.</p>
                <br>
                <div class="container">
                    <div class="row">
                                    ...
                                    <form >
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Concepto" class="form-control input-text" name="concepto" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Valor" class="form-control input-text" name="valor" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="date" placeholder="fecha" class="form-control input-text" name="fecha_generacion" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Banco" class="form-control input-text" name="banco" required="">
                                            </div>
                                        </div>
    
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Url Archivo" class="form-control input-text" name="url" required="">
                                            </div>
                                        </div>
...
customElements.define('my-nuepag',myNuepag);