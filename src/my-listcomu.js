...
export class mylistComu extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Comunicaciones</h3>
                <hr>
    
                <p>A continuación encontrara un listado que contiene la información de todas las comunicaciones
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <form action="listComu.html" style="text-align: left;">
                ...
                <table class="table table-striped-columns">
                    <thead>
                        <tr>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Numero Comunicación</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Titulo</th>
...
customElements.define('my-listcomu',mylistComu);