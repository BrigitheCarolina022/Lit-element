...
export class myListaafi extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                ...
                <hr>
                <p>A continuación encontrara un listado que contiene la información de todos los afiliados a la
                    junta directiva.</p>
                <br>
                <div class="container-fluid">
                    <div class="row">
...
customElements.define('my-listaafi',myListaafi);