...
export class myListaCer extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Lista Certificados</h3>
                <hr>
    
                <p>A continuación encontrara un listado que contiene la información de todas las certificados
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm">
                                    <form action="NuevCert.html" style="text-align: right;">
                                        <button class="btn-new-acta" title="Nueva Acta"><i class="fas fa-circle-plus" aria-hidden="true"></i></button>
                                    </form>
                                </div>
                                <div class="col-sm">
                                    <form action="ListaCer.html" style="text-align: left;">
                ...
                <table class="table table-striped-columns">
                    <thead>
                        <tr>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Certificado Número</th>
                            ...
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Acciones</th>
                        </tr>
                    </thead>
...
customElements.define('my-listacer',myListaCer);