...
export class myListaMater extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3>Lista Material</h3>
                <hr>
                <p>A continuación encontrara un listado de material del equipo PUMAS DC.</p>
                <br>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm">
                                    <form action="NuevCer.html" style="text-align: right;">
                                        <button class="btn-new-acta" title="Nuevo Material"><i class="fas fa-circle-plus" aria-hidden="true"></i></button>
                                    </form>
                                </div>
                                <div class="col-sm">
                                    <form action="ListaMater.html" style="text-align: left;">
                ...
                <table class="table">
                    ...
                    <tr><td style="text-align: left;">1</td><td style="text-align: left;">2</td><td style="text-align: left;">20</td><td style="text-align: left;">2</td><td style="text-align: left;">30</td><td style="text-align: left;">1</td></tr></tbody>
                </table>
            </div>
        </div>
    </div>
...
customElements.define('my-listamater',myListaMater);