...
export class myNuefact extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Nueva Factura</h3>
                <hr>
                <p>A continuación registre los datos basicos de la factura a crear.</p>
                <br>
                <div class="container">
                    <div class="row">
                                    ...
                                    <form >
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="A nombre de" class="form-control input-text" name="nombre" required="">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm text-left" style="text-align: left !important">
                                                <input type="text" placeholder="Url del documento" class="form-control input-text" name="url_documento">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
...
customElements.define('my-nuefact',myNuefact);