...
export class myNueCue extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Nueva Cuenta</h3>
                <hr>
                <p>A continuación registre los datos basicos de la cuenta a crear.</p>
                <br>
                <div class="container">
                    <div class="row">
                                    ...
                                    <form >
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <textarea name="descripcion_corta" id="descripcion_corta" class="form-control" placeholder="Descripción corta"></textarea>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="number" placeholder="Valor a registrar" class="form-control input-text" name="valor_registro" required="">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm text-center" style="text-align: left !important">
                                                <label>Fecha registro</label>
                                                <input type="date" placeholder="Fecha registro" class="form-control input-text" name="fecha_generacion" required="">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <select placeholder="Tipo reunion" class="form-control input-text" name="estado" required="">
                                                    <option value="0">Estado</option>
                                                    <option value="1">Por pago</option>
                                                    <option value="2">Pago en proceso</option>
                                                    <option value="3">Pagado</option>
                                                    <option value="4">No registra</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="number" placeholder="Número de pago registrado" class="form-control input-text" name="numero_pago">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            <div class="col-sm text-left" style="text-align: left !important">
                                                <input type="number" placeholder="Agenda de pago" class="form-control input-text" name="agenda_pago">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <select name="usuario" id="usuario" placeholder="Seleccione Deudor" class="form-control input-text">
                                                    <option value="0">Seleccione Deudor</option>
                                                </select>
                                            </div>
                                        </div>
                                        <br>
...
customElements.define('my-nuecue',myNueCue);