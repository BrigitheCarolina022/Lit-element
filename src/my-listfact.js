...
export class mylistfact extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Lista Facturas</h3>
                <hr>
    
                <p>A continuación encontrara un listado que contiene la información de todas las facturas
                    que se encuentran gestionadas en el sistema.</p>
                <br>
                <br>
                <div class="container-fluid">
                    <div class="row">
                ...
                <table class="table table-striped-columns">
                    <thead>
                        <tr>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Factura N°</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">A nombre de</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Url documento</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Pago asignado</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Valor Pago</th>
                            <th style="text-align: left;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Fecha generación</th>
...
customElements.define('my-listfact',mylistfact);