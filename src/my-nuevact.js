...
export class myNuevAct extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
    ...
    <div class="col-sm-9">
        ...
        <div class="card card-padding box-sombra">
            <div class="container-fluid text-center">
                <h3 class="title-Actas">Nueva Acta</h3>
                <hr>
                <p>A continuación registre los datos basicos que identifican la acta a crear.</p>
                <br>
                <div class="container">
                    <div class="row">
                                    ...
                                    <form >
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="text" placeholder="Titulo" class="form-control input-text" name="titulo">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <input type="date" placeholder="Fecha registro" class="form-control input-text" name="fecha_generacion">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <select placeholder="Estado" class="form-control input-text" name="estado">
                                        ...
                                        <div class="row">
                                            <div class="col-sm text-center">
                                                <textarea class="form-control input-text textArea" placeholder="Descripción" name="descripcion_acta"></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <input type="hidden" name="id_usuario" value="2" id="id_usuario">
                                                <input type="text" placeholder="Usuario" class="form-control input-text" value="" id="usuario">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
...
customElements.define('my-nuevact',myNuevAct);