...
export class myTeso extends LitElement{
    static get styles(){
        return[styleCssn];
    }
    render(){
        ...
        <div class="col-sm">
            <div class="card box-sombra" style="width: 70%;margin-left: 30px;">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img src="img/9.png" class="imagen-cat-secret-tres">
                    </div>
                    <br>
            ...
            <div class="card box-sombra" style="width: 70%;margin-left: 30px;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h5 class="text-cat-scret">Pago</h5>
                            <hr style="width: 100%;">
                        </div>
                        <div class="col-sm">
            ...
            <div class="card box-sombra" style="width: 70%;margin-left: 30px;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h5 class="text-cat-scret">Facturas</h5>
                            <hr style="width: 100%;">
                        </div>
                        <div class="col-sm">
            ...
            <div class="card box-sombra" style="width: 70%;margin-left: 30px;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h5 class="text-cat-scret">Agenda</h5>
                            <hr style="width: 100%;">
                        </div>
                        <div class="col-sm">
...
customElements.define('my-teso',myTeso);